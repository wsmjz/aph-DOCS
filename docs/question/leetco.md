...
- 参与过 js 生态工程能力建设、技术产品化，有良好的商业化思维
- 有前端大规模基础框架研发经历
- 有前端架构、性能体验优化经历
- 有扎实数据结构和编程基本功
- 有 Electron 桌面端应用研发经验
- 有前端组件库开发经验，前端工程化、标准化有充足的实践和方法
- 有大体量应用体验和稳定性优化经验
- 了解互动图形方向相关技术
### 文章
- 资源整合
- this全面解析
- 常见的内存泄漏与避免
- [状态管理器的比较Vuex、Flux、Redux、Redux-saga、Dva、MobX](https://zhuanlan.zhihu.com/p/53599723)
- 使用webpack-bundle-analyzer对项目进行模块分析生成report
- 优化webpack打包速度, [查看](https://muyiy.cn/question/tool/122.html)
   - externals 加入外链
   - 因webpack提供的UglifyJS插件采用单线程压缩，速度很慢。所以将此插件替换为webpack-parallel-uglify-plugin插件，此插件可以并行运行UglifyJS插件，可有效减少构建时间，
## 工作体会
